...
module WordsList =
    ...
    let wordsAndMeaningsSorted =
        [|
         ...
         ("Abrasion", "1. damage to skin caused by scraping; \n2. process of scraping or rubbing [abrade (v)]")
         ...
         ("Azure", "(adj) bright blue in colour like a cloudless sky <thin streaks of cloud trailed across an azure sky> \n\n(n) a bright blue colour <a flash of azure drew my eye to a kingfisher>")
         ("Baleful", "evil")
         ...
         ("Bard", "poet")
         ("Barrage", "extended gunfire to cover an attack; dam across river; \ndeluge or information etc.")
         ...
         ("Blunderbuss", "1. ancient weapon (type of gun); \n2. a clumsy person")
         ...
         ("Cardinal", "1. high ranking church official; \n2. major, important")
         ...
         ("Cobble", "to put together roughly or clumsily; \na small round stone used to cover road surface")
         ("Coda", "piece of music at the end of a musical work; \nfinale; \nfinal part of document")
         ("Coddle", "pamper; fuss over; indulge")
         ("Codify", "to organize things like rules, laws, or principles into a code or system")
         ...
         ("Compromised", "1. damaged or put in doubt (esp. of reputation); \n2. reached an agreement by giving up part of a claim")
         ...
         ("Conscript", "1. person enlisted compulsorily into the armed forces; \n2. (v) to enlist compulsorily")
         ("Consecrate", "dedicate")
         ...
         ("Dilettante", "(n) person who dabbles in a subject without serious study")
         ...
         ("Emancipate", "set free")
         ("Embattled", "engaged in battle or conflict; \nsurrounded by enemies; \nconstantly criticized or attacked \nready to fight: \nprepared to give battle <here once the embattled farmers stood> \n\ncharacterized by conflict or controversy <an embattled presidency>")
         ...
         ("Filibuster", "an action such as prolonged speaking which obstructs progress in a legislative assembly in a way that does not technically contravene the required procedures; synonyms: delaying tactics, stonewalling, procrastination, obstruction, delaying, blocking, hold-up;")
         ("Finesse", "skill")
         ...
         ("Forbidding", "unfriendly or threatening in appearance; \n synonyms: hostile, unwelcoming, unfriendly, unsympathetic, unapproachable, harsh, grim, stern, hard, tough, cool, cold, chilly, frosty")
         ...
         ("Gerontocracy", "government by a council of elders; a governing body consisting of old people")
         ...
         ("Gentry", "(n) people of good social position, specifically the class of people next below the nobility in position and birth \n\n<a member of the landed gentry> \n\nSynonyms: the upper classes, the upper middle class, the privileged classes, the wealthy, the elite, high society, the establishment")
         ...
         ("Jamb", "door post")
         ("Jargon", "special words or expressions used by a profession or group that are difficult for others to understand; \nsynonyms: specialized language, technical language")
         ...
         ("Jockey", "(n) a person who rides in horse races, especially as a profession; \n\n(v) struggle by every available means to gain or achieve something <the two countries are jockeying for dominance in the Pacific>")
         ...
         ("Junta", "group of persons joined in political intrigue; cabal; group of military officers ruling a country after seizing power")
         ...
         ("Knotty", "complex; difficult to solve; intricate; tangled")
         ...
         ("Latent", "hidden; \npotentially existing but not presently evident or realized; \n<About a third of the world has latent tuberculosis, it usually becomes active when an infected person’s immune system is depressed>")
         ...
         ("Longevity", "long life")
         ("Longshoreman", "is a worker who loads and unloads cargo onto ships. \nThese workers are also known in the United Kingdom as 'dockers', in continental Europe as 'stevedores' and more generally as dockworkers")
         ...
         ("Mallet", "1. wooden hammer; \n2. stick used for polo")
         ("Manacle", "confine or restrain with or as if with handcuffs")
         ...
         ("Prescient", "having or showing knowledge of events before they take place; synonyms:	prophetic, predictive, visionary")
         ...
         ("Quintessential", "most typical; \nthe perfect example of [quintessence (n)]")
         ("Quirk", "oddity")
         ("Quisling", "traitor")
         ...
         ("Staunch", "1. very loyal and committed in attitude; \n<a staunch supporter of the anti-nuclear lobby> \nSynonyms: stalwart, faithful, trusty, devoted, dedicated, dependable, reliable, steady, constant, hard-working, vigorous, stable, firm, steadfast, redoubtable, resolute, unswerving, unwavering, unhesitating, unfaltering \n\n2. (of a wall) of strong or firm construction; \n<these staunch walls could withstand attack by cannon>")
         ...
         ("Venturing",
          "1. hazarding; risking; putting forward; \n2. going somewhere [venturesome means courageous or willing to take risks]")
         ...
         ("Voracious", "ravenous")
         ("Vulpine", "like a fox \n\nNote: bovine (cow-like), porcine (pig-like)")
         ("Waffle", "BRITISH: speak or write at length in a vague or trivial manner. \n<he waffled on about his problems> \nsynonyms: prattle, chatter, babble, ramble, jabber, gibber, drivel, rattle on, gabble, gab, burble, bleat, cackle; \n \nNORTH AMERICAN: fail to make up one's mind. \n<Joseph had been waffling over where to go> \nsynonyms:waver, hesitate, falter, fluctuate, dither, vacillate, seesaw, blow hot and cold, be indecisive, be irresolute, hum and haw, shillyshally")
         ...
         ("Yarmulke", "A skullcap worn by Jewish men and boys, especially those adhering to Orthodox or Conservative Judaism.")
         ...
         ("Yen", "strong desire; longing; urge; <yen for travel>")
         ("Yeoman", "one that performs great and loyal service; man or farmer owning small estate; middle-class farmer")
         ("Yield", "amount produced; crop; income on investment; profit obtained from an investment")
         ("Yoke", "join together; unite")
         ("Yokel", "a derogatory term for  an uneducated and unsophisticated person from the countryside; synonyms bumpkin, country bumpkin, country cousin, rustic, countryman,")
