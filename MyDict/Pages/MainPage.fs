...
type MainPage() =
    ...
    let wordMeaning = [|
                       ...
                       |]
    let numWords = Array.length(wordMeaning)
    ...
    let wordMeaningTextEditor = new Editor(TextColor = Color.Yellow,
                                           BackgroundColor = Color.Black,
    ...
    do
        ...
        List.map layout.Children.Add ([showNextWordButton
                                       ...
                                       // countDownLabel
                                       wordTextEntry
                                       wordMeaningTextEditor
                                       resetButton
                                       ]: View list) |> ignore

        showNextWordButton.Clicked.Add (fun eventargs ->
                                          let wrd = wordMeaning.[index]
                                          wordTextEntry.Text <- fst wrd
                                          wordMeaningTextEditor.Text <- snd wrd
